IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE ID = OBJECT_ID(N'[dbo].[FN_GetPY]') AND xType IN (N'FN', N'IF', N'TF'))
...
/*
     ...
     返回值:汉字的拼音首字母
*/ 
create function FN_GetPY(@str varchar(500))
returns varchar(500)
as
begin
